...
**Example**
One player says, “Instead of saying ‘four,’ we’re going to clap.” // You then count together: 1, 2, 3, clap, 5. // Next, another player adds a rule, such as, “Instead of saying ‘two,’ we shout ‘Yippee!’” // Now you count: 1, Yippee!, 3, clap, 5.
...
**Example**
Player one says “horse.” // Player two says “shoe.” // Player one says “sock.”
...

{
  ...
  text: `**How to play**
This is a more challenging twist on word association where players secretly skip a step. // The first person says a random word. // The next person thinks of a word related to it but does not say it out loud. // Instead, they say a word associated with that secret middle word. // Each player continues using the same “secret middle” rule.

**Example**
Player one says “banana.” // Player two thinks “yellow” but says “sun.” // The next player might think “hot” and say “cheese.”
...
**Example**
Player one says “potato” and pretends to throw the ball. // Player two “catches” it, repeats “potato,” then throws it back saying “mash.” // Player one catches, repeats “mash,” and throws it back saying “squish.”
...
**Example**
Player one makes an over-the-top grossed-out face with their tongue sticking out and eyes squinting. // Player two says, “Ewww, I can’t believe I just drank milk that expired in 1972!” // Then switch roles and repeat.
